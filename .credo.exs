...
%{
  ...
  configs: [
    %{
      ...
      #
      checks: %{
        # ExSlop registers as a plugin, but an explicit `enabled:` list is
        # authoritative for Credo and discards a plugin's default checks —
        # its AI-slop checks only run when appended here.
        enabled:
          [
            #
            ## Consistency Checks
